                            ...
                            <c:forEach items="${permissionList}" var="permission">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="javascript:deletePermission('${permission.id}');"
                                           class="btn bg-olive btn-xs">移除该权限</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
...
<script>
    function deletePermission(id){
        if(confirm("确定要移除吗？")){
            location.href="${pageContext.request.contextPath}/permission/delete.do?id="+id;
        }
    }

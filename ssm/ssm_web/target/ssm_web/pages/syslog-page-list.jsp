                        ...
                        <table id="dataList"
                            ...
                            <c:forEach items="${pageInfo.list}" var="syslog">
                                <tr>
                                    ...
                                    <td>${syslog.method}</td>
                                    <td><a href="javascript:deleteSysLog('${syslog.id}');" class="btn bg-olive btn-xs">删除</a></td>
                                </tr>
                            </c:forEach>
                            </tbody>
...
<script>
    function deleteSysLog(id) {
        if(confirm("确定删除这个记录吗？")){
            location.href="${pageContext.request.contextPath}/sysLog/deleteSysLog.do?id="+id;
        }
    }
